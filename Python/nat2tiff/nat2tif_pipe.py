...
### Takes the individual .tif files and plot them with matplotlib. Every time this script is called, it output new .png filenames but overwrites the former .tif files inside the folder in order to save space.
